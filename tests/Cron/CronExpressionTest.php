...
class CronExpressionTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        // '2010-09-10 12:00:00'
        $cron = CronExpression::factory('0 1 2-4 * 4,5,6 */3');
        ...
        $this->assertEquals('0 1 2-4 * 4,5,6 */3', $cron->getExpression());
        $this->assertEquals('0 1 2-4 * 4,5,6 */3', (string) $cron);
    ...
    public function scheduleProvider()
    {
        return array(
            ...
            array('0 * * * * *', '2015-08-10 21:50:37', '2015-08-10 21:51:00', false),
            array('37 * * * * *', '2015-08-10 21:50:37', '2015-08-10 21:50:37', true),
            ...
            array('30 47 21 * * *', strtotime('2015-08-10 21:47:30'), '2015-08-10 21:47:30', true),
            ...
            // Test the year field
            array('0 * * * * * 2012', strtotime('2011-05-01 00:00:00'), '2012-01-01 00:00:00', false),
    ...
    {
        $cron = CronExpression::factory('0 0 15 * * 3'); //Wednesday at 15:00
        $date = '2014-01-01 15:00:00'; //Wednesday
        ...
        $this->assertTrue($cron->isDue(new DateTime($date)));
        ...
        $cron->setTimezone('UTC');
        $this->assertFalse($cron->isDue(new DateTime($date)));
        $this->assertTrue($cron->isDue(new DateTime($date, $utc)));
        $this->assertFalse($cron->isDue(new DateTime($date, $amsterdam)));
        $this->assertFalse($cron->isDue(new DateTime($date, $tokyo)));

        date_default_timezone_set('Asia/Tokyo');
        $cron->setTimezone('Asia/Tokyo');
        $this->assertTrue($cron->isDue(new DateTime($date)));
        $this->assertFalse($cron->isDue(new DateTime($date, $utc)));
        $this->assertFalse($cron->isDue(new DateTime($date, $amsterdam)));
    ...
    public function testProvidesMultipleRunDatesForTheFarFuture() {
        // Fails with the default 10000 iteration limit
        $cron = CronExpression::factory('0 0 0 12 1 * */2');
    ...
    public function testIssue20() {
        $e = CronExpression::factory('0 * * * * MON#1');
        ...
        $e = CronExpression::factory('0 * * * * SAT#2');
        ...
        $e = CronExpression::factory('0 * * * * SUN#3');
    ...
    public function testKeepOriginalTime()
    {
        ...
        $cron = CronExpression::factory('0 0 0 * * *');
